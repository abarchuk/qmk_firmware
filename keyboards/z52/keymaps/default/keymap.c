...
[SYMB] = { 
    ...
    { KC_TILD, KC_GRV,  KC_LPRN, KC_RPRN, KC_TAB,  KC_TRNS, KC_BSPC, KC_LCBR, KC_RCBR, KC_LBRC, KC_RBRC },
    { KC_PLUS, KC_EQL,  KC_UNDS, KC_MINS, KC_ESC,  KC_TRNS, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_TRNS },
    { KC_PIPE, KC_BSLS, KC_DQT,  KC_QUOT, KC_ENT,  KC_TRNS, KC_DEL,  KC_PGDN, KC_PGUP, KC_HOME, KC_END  },
    { KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS }
},

[NUM] = {
    { KC_F11,  KC_F12,  _CP,     _PST,    KC_TRNS, KC_TRNS, KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT, KC_MPLY },
    { KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_TRNS, KC_6,    KC_7,    KC_8,    KC_9,    KC_0    },
    { KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_TRNS, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN },
    { KC_TRNS, KC_TRNS, _CP,     _PST,    KC_TRNS, KC_TRNS, KC_TRNS, KC_PLUS, KC_EQL,  KC_SLSH, KC_ASTR },
    { KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS }
}
