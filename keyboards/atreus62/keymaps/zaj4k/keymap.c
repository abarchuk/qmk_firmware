...
[_DEFAULT] = {
		...
		{ KC_LGUI, KC_MINS, KC_EQL,  KC_LCTL, KC_LALT, KC_LSFT, KC_SPC,  MO(SYMB),MO(NUM), KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT }
},

[SYMB] = { 
		{ _______, _______, _______, _CP,     _PST,    _______, _______, KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT, KC_MPLY, _______ },
		{ _______, KC_TILD, KC_GRV,  KC_LPRN, KC_RPRN, KC_TAB,  _______, KC_BSPC, KC_LCBR, KC_RCBR, KC_LBRC, KC_RBRC, _______ },
...
[NUM] = { 
		...
		{ _______, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    _______, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_F12  },
		{ _______, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  _______, _______, KC_MINS, KC_PLUS, KC_EQL,  KC_SLSH, KC_ASTR, _______ },
		{ _______, KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, _______, _______, _______, _______, _______, _______, _______, _______ },
		{ _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______ }
}
