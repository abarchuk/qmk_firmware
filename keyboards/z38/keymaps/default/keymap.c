...
[_DEFAULT] = {
    ...
    { KC_TRNS, KC_TRNS, KC_TRNS, KC_LCTL, MO(_LOWER), KC_SPC,  MO(_RAISE),KC_LALT, MO(MED), KC_TRNS, KC_TRNS }
},
...
[_RAISE] = { 
    ...
    { KC_LCBR, KC_RCBR, KC_LBRC, KC_RBRC, KC_ENT,  KC_TRNS, KC_INS,  KC_PGDN, KC_END,  KC_DQT,  KC_QUOT },
